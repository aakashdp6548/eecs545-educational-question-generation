...
class FusedEmbeddingConstruction(EmbeddingConstructionBase):
    ...
    def __init__(
        ...
        enc_input_dim = word_emb_size #* 2 #TODO
        bert_dim = 0
    ...
    def forward(self, data):
        ...
        # answer_feat = self.ans_rnn_encoder(answer_feat, data["input_length2"])    # TODO
        ...
        ctx_feat = self.ctx_rnn_encoder_l2(ctx_feat, ctx_length)    # only use the context, not the answer embeddings
